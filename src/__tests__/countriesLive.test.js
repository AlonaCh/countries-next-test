...
test('getAll returns data from the API', async () => { //because it is async function we need to use async/await
    //call the func
    const data = await countries.getAll()

    //check if the data is an array(since the API returns an array of countries)
